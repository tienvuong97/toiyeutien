...
return [
    ...
    'blog' => [
        ...
        'tab_general' => 'General',
        'access_comments' => 'Manage comments',
    ],
    'posts' => [
    ...
    'post' => [
        ...
        'highlight_post'    => 'Highlight',
        'highlight_post_description'    => 'List of highlighted posts'
    ],
    'categories' => [
    ...
    'tag' => [
        ...
        'delete_success' => 'Successfully deleted those tag.',
        'return_to_tags' => 'Return to the tag list',
        'create_tag' => 'Create New Tag'
    ],
    'tag_search' => [
        'tagURL'=>'Tag URL',
        'tagURL_description' => 'The URL parameter used to search for posts.',
        'name_placeholder' => 'New tag name',
        'description' => 'Description',
        'slug' => 'Slug',
        'slug_placeholder' => 'new-tag-slug',
    ...
    'comment'=>[
        ...
        'posts_label'=> 'Title Post',
        'return_to_comments' => 'Return to the comment list',
        'back' => 'Back',
        'comment_form' => 'Comment Form',
        'description'=> 'This is the comment form',
        'add_cmt_success' => 'Your comment has been sent successfully!',
        'your_comment' => 'Your comment',
        'list_comment' => 'A list of comments in post'
    ],
    'tags' => [
        'new_tag' => 'New Tag',
        'order_by_title' => 'Sort by',
        'order_by_description' => 'The value used to sort tags.',
        'hide_title' => 'Hide orphaned tags',
        'hide_description' => 'Hides tags with no associated posts.',
        'results_number_title' => 'Number of tags',
        'results_number_description' => 'Number of displayed tags (zero displays all tags).',
        'direction_title' => 'Order',
        'direction_description' => 'The order to sort tags in.',
        'results_validation' => 'Invalid format of the number of tags value',
        'remove_orphaned_tags' => 'Remove Orphaned Tags',
        'return_to_tags' => 'Return to the blog tag list',
        'delete_orphaned_success' => 'Successfully deleted orphaned tags',
        'delete_success' => 'Successfully deleted tags',
        'unknown_error' => 'An unknown error has occurred',
        'add_tags' => 'Add tags',
        'required_field' => 'This Tag field is required.',
        'unique_name' => 'This tag already exists. Register new one!',
        ...
        'tag_slug' => 'Slug',
        'tag_slug_description' => 'Look up the blog tag using the supplied slug value. This property is used by the default component partial for marking the currently active tag.'
    ],
    ...
    'settings' => [
        ...
        'tags_filter_description' => 'Enter a tag slug or URL parameter to filter the posts by. Leave empty to show all posts.',
        ...
        'search_post_title' => 'Search Post',
        'search_post_description' => 'Displays a form of search post on your page.',
        'tags_list_title' => 'Tags List',
        'tags_list_description' => 'Displays a list of tags on your page.',
        'search_form' => 'Search Form',
        'search_form_description' => 'Outputs a search form for the blog.',
        'search_result' => 'Search Result',
        'search_result_description' => 'Displays a list of blog posts that match the search term on the page.',
        'search_result_page_title'   => 'Search Results Page',
        'search_term_title' => 'Search Term',
        'search_term_description' => 'The value to determine what the user is searching for.',
        'disable_url_mapping_title'       => 'Disable URL Mapping',
        'disable_url_mapping_description' => 'If the url Mapping is disabled the search form uses the default GET Parameter q '
                                    . '(e.g. example.com/search?search=Foo instead of example.com/search/Foo)',
        'hightlight_match_title'       => 'Hightlight Matches',
        'highlight' => 'Highlight',
        'no_highlight' => 'None',
    ],
    'sorting' => [
    ...
    'share' => [
        'share_name'        => 'Share',
        'share_description' => 'Display Share Button',
        'appid_title'       => 'appId',
        'appid_description' => 'This is app Id of Facebook'
