...
class RssFeed extends ComponentBase
{
    ...
    {
        return [
            'name'        => 'ncc.blog::lang.settings.rssfeed_title',
            'description' => 'ncc.blog::lang.settings.rssfeed_description'
        ];
    }
    ...
    public function defineProperties()
    {
        return [
            ...
            'blogPage' => [
                'title'       => 'ncc.blog::lang.settings.rssfeed_blog',
                'description' => 'ncc.blog::lang.settings.rssfeed_blog_description',
                'type'        => 'dropdown',
                'default'     => 'blog/post',
