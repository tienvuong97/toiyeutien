...
class Categories extends ComponentBase
{
    ...
    {
        return [
            'name'        => 'ncc.blog::lang.settings.category_title',
            'description' => 'ncc.blog::lang.settings.category_description'
        ];
    }
    ...
    public function defineProperties()
    {
        return [
            'slug' => [
                'title'       => 'ncc.blog::lang.settings.category_slug',
                'description' => 'ncc.blog::lang.settings.category_slug_description',
                'default'     => '{{ :slug }}',
                'type'        => 'string',
            ],
            'displayEmpty' => [
                'title'       => 'ncc.blog::lang.settings.category_display_empty',
                'description' => 'ncc.blog::lang.settings.category_display_empty_description',
                'type'        => 'checkbox',
                'default'     => 0,
            ],
            'categoryPage' => [
                'title'       => 'ncc.blog::lang.settings.category_page',
                'description' => 'ncc.blog::lang.settings.category_page_description',
                'type'        => 'dropdown',
