...
class Post extends Model
{
    ...
    public $table = 'ncc_blog_posts';
    public $implement = ['@Ncc.Translate.Behaviors.TranslatableModel'];
    ...
    public $rules = [
        'title'   => 'required',
        'slug'    => ['required', 'regex:/^[a-z0-9\/\:_\-\*\[\]\+\?\|]*$/i', 'unique:ncc_blog_posts'],
        'content' => 'required',
    ...
    public static $allowedSortingOptions = [
        'title asc'         => 'ncc.blog::lang.sorting.title_asc',
        'title desc'        => 'ncc.blog::lang.sorting.title_desc',
        'created_at asc'    => 'ncc.blog::lang.sorting.created_asc',
        'created_at desc'   => 'ncc.blog::lang.sorting.created_desc',
        'updated_at asc'    => 'ncc.blog::lang.sorting.updated_asc',
        'updated_at desc'   => 'ncc.blog::lang.sorting.updated_desc',
        'published_at asc'  => 'ncc.blog::lang.sorting.published_asc',
        'published_at desc' => 'ncc.blog::lang.sorting.published_desc',
        'random'            => 'ncc.blog::lang.sorting.random'
    ];
    ...
    public $belongsToMany = [
        'categories' => [
            'Ncc\Blog\Models\Category',
            'table' => 'ncc_blog_posts_categories',
            'order' => 'name'
        ],
        'tags' => [
                'Ncc\Blog\Models\Tag',
    ...
    public $hasMany = [
        'comments' =>['Ncc\Blog\Models\Comment',
    ...
    public function filterFields($fields, $context = null)
    {
        ...
        if (!$user->hasAnyAccess(['ncc.blog.access_publish'])) {
    ...
    public function afterValidate()
    {
        if ($this->published && !$this->published_at) {
            throw new ValidationException([
               'published_at' => Lang::get('ncc.blog::lang.post.published_validation')
            ]);
        }
    }
    ...
    {
        return ($this->user_id == $user->id) || $user->hasAnyAccess(['ncc.blog.access_other_posts']);
    }
     ...
     *
     * @param \Ncc\Pages\Classes\MenuItem $item Specifies the menu item.
