...
class Category extends Model
{
    ...
    public $table = 'ncc_blog_categories';
    ...
    public $rules = [
        'name' => 'required',
        'slug' => 'required|between:3,64|unique:ncc_blog_categories',
        'code' => 'nullable|unique:ncc_blog_categories',
    ];
    ...
    public $belongsToMany = [
        ...
        'posts_count' => ['Ncc\Blog\Models\Post',
            'table' => 'ncc_blog_posts_categories',
            'scope' => 'isPublished',
            'count' => true
        ]
