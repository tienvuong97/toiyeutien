<?php namespace Ncc\User\Tests\Unit\Facades;

use Auth;
use Ncc\User\Models\User;
use Ncc\User\Tests\PluginTestCase;
...
class AuthFacadeTest extends PluginTestCase
{
    public function test_registering_a_user()
    {
        ...
        $this->assertInstanceOf('Ncc\User\Models\User', $user);
    ...
    public function test_registering_a_guest()
    {
        ...
        $this->assertEquals(1, User::count());
        $this->assertInstanceOf('Ncc\User\Models\User', $guest);
