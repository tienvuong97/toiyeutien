<?php namespace Ncc\User\Classes;

use October\Rain\Auth\Manager as RainAuthManager;
use Ncc\User\Models\Settings as UserSettings;
use Ncc\User\Models\UserGroup as UserGroupModel;
...
class AuthManager extends RainAuthManager
{
    ...
    protected $userModel = 'Ncc\User\Models\User';

    protected $groupModel = 'Ncc\User\Models\UserGroup';

    protected $throttleModel = 'Ncc\User\Models\Throttle';
