<?php namespace Ncc\User\Controllers;
...
use Ncc\User\Models\User;
use Ncc\User\Models\UserGroup;
...
class Users extends Controller
{
     ...
     */
    public $requiredPermissions = ['ncc.users.access_users'];
    ...
    public function __construct()
    {
        ...
        BackendMenu::setContext('Ncc.User', 'user', 'users');
        SettingsManager::setContext('Ncc.User', 'settings');
    }

    public function index()
    {
        $this->addJs('/plugins/ncc/user/assets/js/bulk-actions.js');
    ...
    public function preview_onActivate($recordId = null)
    {
        ...
        Flash::success(Lang::get('ncc.user::lang.users.activated_success'));
    ...
    public function preview_onUnban($recordId = null)
    {
        ...
        Flash::success(Lang::get('ncc.user::lang.users.unbanned_success'));
    ...
    public function preview_onConvertGuest($recordId)
    {
        ...
        Flash::success(Lang::get('ncc.user::lang.users.convert_guest_success'));
    ...
    {
        if (!$this->user->hasAccess('ncc.users.impersonate_user')) {
        ...
        Flash::success(Lang::get('ncc.user::lang.users.impersonate_success'));
    }
    ...
    public function preview_onUnsuspendUser($recordId)
    {
        ...
        Flash::success(Lang::get('ncc.user::lang.users.unsuspend_success'));
    ...
    public function index_onBulkAction()
    {
        if (
            ...
            Flash::success(Lang::get('ncc.user::lang.users.'.$bulkAction.'_selected_success'));
        }
        else {
            Flash::error(Lang::get('ncc.user::lang.users.'.$bulkAction.'_selected_empty'));
        }
